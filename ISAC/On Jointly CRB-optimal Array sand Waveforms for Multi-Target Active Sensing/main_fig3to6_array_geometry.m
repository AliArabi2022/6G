...
stem(Dt_3b(:,1)/halfLambda, ones(size(Dt_3b,1),1), 'filled', 'DisplayName','Dt'); hold on; grid on;
stem(Dr_3b(:,1)/halfLambda, 2*ones(size(Dr_3b,1),1), 'filled', 'DisplayName','Dr');
ylim([0 3]); yticks([1 2]); yticklabels({'Dt','Dr'});
...
subplot(1,2,1);
scatter(Dt_4b(:,1)/halfLambda, Dt_4b(:,2)/halfLambda, 50, 'filled'); grid on; axis equal;
xlabel('d_{t,1} [\lambda/2]'); ylabel('d_{t,2} [\lambda/2]'); title('Tx');
subplot(1,2,2);
scatter(Dr_4b(:,1)/halfLambda, Dr_4b(:,2)/halfLambda, 50, 'filled', 'MarkerFaceColor', [0.85 0.33 0.1]);
grid on; axis equal;
xlabel('d_{r,1} [\lambda/2]'); ylabel('d_{r,2} [\lambda/2]'); title('Rx');
...
subplot(1,2,1);
scatter(Dt_4c(:,1)/halfLambda, Dt_4c(:,2)/halfLambda, 50, 'filled'); grid on; axis equal;
xlabel('d_{t,1} [\lambda/2]'); ylabel('d_{t,2} [\lambda/2]'); title('Tx');
subplot(1,2,2);
scatter(Dr_4c(:,1)/halfLambda, Dr_4c(:,2)/halfLambda, 50, 'filled', 'MarkerFaceColor', [0.85 0.33 0.1]);
grid on; axis equal;
xlabel('d_{r,1} [\lambda/2]'); ylabel('d_{r,2} [\lambda/2]'); title('Rx');
...
subplot(1,2,1);
scatter3(Dt_5b(:,1)/halfLambda, Dt_5b(:,2)/halfLambda, Dt_5b(:,3)/halfLambda, 50, 'filled');
grid on; xlabel('d_{t,1}'); ylabel('d_{t,2}'); zlabel('d_{t,3}'); title('Tx');
subplot(1,2,2);
scatter3(Dr_5b(:,1)/halfLambda, Dr_5b(:,2)/halfLambda, Dr_5b(:,3)/halfLambda, 50, 'filled', ...
    'MarkerFaceColor',[0.85 0.33 0.1]);
grid on; xlabel('d_{r,1}'); ylabel('d_{r,2}'); zlabel('d_{r,3}'); title('Rx');
